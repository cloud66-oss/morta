...
gox -ldflags "-X github.com/cloud66-oss/shutdown-sequencer/utils.Version=$version -X github.com/cloud66-oss/shutdown-sequencer/utils.Channel=$channel" -os="darwin linux windows" -arch="amd64" -output "build/{{.OS}}_{{.Arch}}_$version"
